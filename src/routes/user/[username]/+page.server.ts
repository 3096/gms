...
import { queryTotalHours, queryTotalMoney, queryUserFavorite, queryUserReview } from '$lib/server/db/user_game.js';
...
// export async function _getFavorites(userID : number) {

//     return {
//         favList: await queryUserFavorite(sql, userID)
//     }

// }

// export async function _getTotalHours (userID : number) {
//     return {
//         sum: await queryTotalHours(sql, userID)
//     }
